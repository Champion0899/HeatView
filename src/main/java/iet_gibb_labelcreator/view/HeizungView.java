package iet_gibb_labelcreator.view;
...
public  class HeizungView implements ControllerViewInterface {
    protected Stage stage;
    protected HeizungController controller;

    public HeizungView(Stage stage, HeizungController controller) {
        this.stage = stage;
        this.controller = controller;
    }
    @Override
    public void startView(InterfaceHeizung data) {
     ...
     * @param layout
     */
    protected void addPropertyToPane(Property property, TilePane layout) {
